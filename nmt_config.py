...
#-----------------------------------------------------------------
    ...
    # subtitles data
    model_dir = os.path.join("hu_en_model2_{0:d}".format(NUM_SENTENCES))
    input_dir = os.path.join("hu_en_data2_{0:d}".format(NUM_SENTENCES))
    data_dir = os.path.join("hu_en_data2")
    # Subtitiles data
...
#-----------------------------------------------------------------
    ...
    model_dir = os.path.join("in_en_model2_{0:d}".format(NUM_SENTENCES))
    input_dir = os.path.join("in_en_data2_{0:d}".format(NUM_SENTENCES))
    data_dir = os.path.join("in_en_data2")
    # use 90% of the data for training
    NUM_TRAINING_SENTENCES = (NUM_SENTENCES * 90) // 100
    # remaining (max 10%) left to be used for dev. For training, we limit the dev size to 500 to speed up perplexity and Bleu computation
    NUM_DEV_SENTENCES = 500
